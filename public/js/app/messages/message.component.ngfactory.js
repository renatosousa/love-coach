...
export function viewFactory_MessageComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_MessageComponent === null)) {
        (renderType_MessageComponent = viewUtils.createRenderComponentType('C:/node/08 Optimizations/assets/app/messages/message.component.html', 0, import9.ViewEncapsulation.Emulated, styles_MessageComponent, {}));
    }
